...
<body>
	<center>
		<table style="margin-top:3%;" width="625">
			...
			<tr height="40">
				<td>
					<center><u style="margin-bottom:-2px;" class="fontsurat"><b>SURAT KETERANGAN PEMBUATAN KARTU KELUARGA (KK)</b></u></center>
		...
		<table width="625">
			<tr class="text2">
				<td>&nbsp; &nbsp; &nbsp; &nbsp; Yang bertanda tangan dibawah ini adalah Kepala Desa Bahagia Kecamatan Babelan Kabupaten Bekasi, Menerangkan
					dengan benar berdasarkan sumpah jabatan, Kepala Keluarga :
				</td>
			</tr>
		</table>
		<br>
		...
		<table width="625">
			<tr>
				<td>
					<font size="2">&nbsp; &nbsp; &nbsp; &nbsp; Bahwa KARTU KELUARGA milik yang namanya di atas masih sementara dalam masa proses pengurusan.
						Adapun susunan Anggota Keluarga berdasarkan Dokumen pendataan kependudukan Desa Bahagia sebagai berikut.
					</font>
				</td>
			</tr>
		</table>
		...
		<table class="textstyle" border="1" width="625">
			<tr>
				<th>No</th>
				<th>Nama Lengkap</th>
				<th>NIK</th>
				...
				<th>Tanggal Lahir</th>
				<th>Agama</th>
				<th width="60">Status Hub. dalam keluarga</th>
			</tr>
			<?php
			$no = 1;
