...
<body>
    ...
    <header>
        ...
        <nav class="navbar">
            <a class="active" href="#terbaru">Terbaru</a>
        ...
        <div class="icons">
            ...
            <a href="komentar.php" class="fas fa-comments"></a>
    ...
    <section class="about" id="layanan">
