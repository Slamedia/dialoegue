...
if (isset($_POST['tombol_tambah'])) {
	...
	if ($add_status) {
		...
		echo "<script type='text/javascript'>alert('Gagal Melakukan pelayanan Kartu Keluarga, Silahkan Hubungi Admin Melalui Kontak Pada Halaman Utama Kami :)');window.location.href = 'kk_baru.php';</script>";
	}
}
?>
<!DOCTYPE html>
							...
							<div class="row">
								<div class="col-md-6">
									<form id="form1" action="" method="post" enctype="multipart/form-data">
										...
										<div class="form-group">
											...
											<div class="input-group">
												<input type="text" class="form-control" name="keterangan_pelayanan" readonly value="Membuat Kartu Keluarga Baru" placeholder="Masukan Pelayanan">
												<div class="input-group-append">
								...
								<div class="col-md-6" id="tampil">
									...
									<div class="form-group">
										...
										<p>
											<font color="red">*Untuk Kartu Keluarga Kehilangan tersedia di menu khusus surat kehilangan diwajibkan untuk mengisi foto surat kehilangan Kartu Keluarga dan Foto Kartu Keluarga Lama.<br>
											</font>
										</p>
									</div>
									<div class="form-group">
