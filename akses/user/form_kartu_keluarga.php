...
if (isset($_POST['tombol_tambah'])) {
  ...
  $addKartukeluarga = $lib->add_KK($kd_KK, $nama_kk, $almt, $rt, $rw, $kode_ps, $kel, $kec, $kab, $prov, $tglSah);
  if ($addKartukeluarga) {
    echo "<script type='text/javascript'>alert('Berhasil Menambah Data Kartu Keluarga!');window.location.href = 'index.php';</script>";
  } else {
    echo "<script type='text/javascript'>alert('Gagal Menambah Data Kartu Keluarga, Silahkan Hubungi Admin Melalui Kontak Pada Halaman Utama Kami :)');window.location.href = 'index.php';</script>";
  }
}
?>
<!DOCTYPE html>
              ...
              <div class="row">
                  ...
                  <form action="" method="post">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <input type="text" class="form-control" name="no_kkx" placeholder="Masukan Nomor Kartu Keluarga">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <input type="text" class="form-control" name="nama_kepalaKeluargax" placeholder="Masukan Nama Kepala Keluarga">
                        <div class="input-group-append">
                    ...
                    <div class="form-group">
                      <label>Alamat:</label>
                      <div class="input-group">
                        <input type="text" class="form-control" name="alamatx" placeholder="Masukan Alamat Kartu Keluarga">
                        <div class="input-group-append">
                    ...
                    <div class="form-group inline">
                      <label>RT:</label>
                      <div class="input-group">
                        <input type="text" class="form-control" name="rtx" placeholder="Masukan RT">
                        <div class="input-group-append">
                    ...
                    <div class="form-group">
                      <label>RW:</label>
                      <div class="input-group">
                        <input type="text" class="form-control" name="rwx" placeholder="Masukan RW">
                        <div class="input-group-append">
                          <div class="input-group-text"><i class="fa fa-thumbtack"></i></div>
                        </div>
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <input type="text" class="form-control" name="zipx" placeholder="Masukan Kode Pos">
                        <div class="input-group-append">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" name="kelurahanx" placeholder="Masukan Kelurahan">
                      <div class="input-group-append">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" name="kecamatanx" placeholder="Masukan Kecamatan">
                      <div class="input-group-append">
                        <div class="input-group-text"><i class="fa fa-map"></i></div>
                      </div>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" name="kabupatenx" placeholder="Masukan Kabupaten/Kota">
                      <div class="input-group-append">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" name="propinsix" placeholder="Masukan Provinsi">
                      <div class="input-group-append">
                        <div class="input-group-text"><i class="fa fa-map"></i></div>
                      </div>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" name="tglsahKKx" placeholder="Masukan Tanggal Sah Kartu Keluarga">
                      <div class="input-group-append">
