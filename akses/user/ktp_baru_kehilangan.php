...
if (isset($_POST['tombol_tambah'])) {
	...
	$add_status = $lib->registrasiPelayananKTPKehilangan(
		$kd,
		$kd_p,
		$nama,
		$tgl,
	...
	if ($add_status) {
		echo "<script type='text/javascript'>alert('Berhasil melakukan pelayanan KTP!');window.location.href = 'ktp_baru_kehilangan.php';</script>";
	} else {
		echo "<script type='text/javascript'>alert('Gagal Melakukan pelayanan KTP, Silahkan Hubungi Admin Melalui Kontak Pada Halaman Utama Kami :)');window.location.href = 'ktp_baru_kehilangan.php';</script>";
	}
}
?>
<!DOCTYPE html>
...
<head>
	...
	<title>SPPDB - Pelayanan KTP Kehilangan</title>
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item has-treeview">
									...
									<ul class="nav nav-treeview">
										...
										<li class="nav-item">
											<a href="ktp_baru_kehilangan.php" class="nav-link bg-cyan">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>Formulir Pelayanan KTP Baru (Kehilangan )</h1>
						</div>
						<div class="col-sm-6">
							...
							<div class="row">
								<div class="col-md-6">
									<form id="form1" action="" method="post" enctype="multipart/form-data">
										...
										<div class="form-group">
											...
											<div class="input-group">
												<input type="text" class="form-control" name="keterangan_pelayanan" readonly value="Membuat KTP Baru Kehilangan" placeholder="Masukan Nomor NIK">
												<div class="input-group-append">
								...
								<div class="col-md-6" id="tampil">
									...
									<div class="form-group">
										...
										<p>
											<font color="red">*Untuk KTP Kehilangan diwajibkan untuk mengisi foto surat kehilangan KTP.</font><br>
