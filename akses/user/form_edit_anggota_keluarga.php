...
if (isset($_GET['id_anggota'])) {
    $kd_ang = $_GET['id_anggota'];
    $data_ang = $lib->get_by_id_anggota($kd_ang);
} else {
...
if (isset($_POST['tombol_ubah'])) {
    ...
    $add_status = $lib->updateAnggotaKel($id_a, $kd, $kk, $allN, $agama, $pek, $kew, $kel, $tml, $tgl, $jk, $gol, $perk);
    if ($add_status) {
        echo "<script type='text/javascript'>alert('Berhasil Mengubah Data Anggota Keluarga!');window.location.href = 'tabel_anggota_keluarga.php';</script>";
    } else {
...
<head>
    ...
    <title>SPPDB - Form Anggota Keluarga</title>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Formulir Anggota Keluarga</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="index.php">Beranda</a></li>
                                <li class="breadcrumb-item active">Formulir</li>
                                <li class="breadcrumb-item active">Formulir Anggota Keluarga</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                    ...
                                    <form action="" method="post">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" readonly name="nomor_kkeluarga" value="<?= $data_ang['no_kk']; ?>" placeholder="Masukan Nomor Kartu Keluarga">
                                        ...
                                        <div class="form-group">
                                            <label>NIK:</label>
                                            <div class="input-group">
                                                <input type="hidden" class="form-control" name="id_anggota" value="<?= $data_ang['id_anggota']; ?>">
                                                <input type="text" class="form-control" name="nik" value="<?= $data_ang['nik']; ?>" placeholder="Masukan Nomor Kartu Keluarga">
                                                <div class="input-group-append">
                                                    <div class="input-group-text"><i class="fas fa-id-badge"></i></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="all_name" value="<?= $data_ang['nama_lengkap']; ?>" placeholder="Masukan Nama Lengkap">
                                                <div class="input-group-append">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control" name="pekerjaan" max="100" value="<?php echo $data_ang['pekerjaan']; ?>" placeholder="Masukan Nomer Pekerjaan">
                                                <div class="input-group-append">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="radio-inline">
                                            <input type="radio" name="kewarganegaraan" value="WNI" <?php if ($data_ang['kewarganegaraan'] == 'WNI') {
                                                                                                        echo 'checked';
                                                                                                    } ?>> WNI
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="kewarganegaraan" value="WNA" <?php if ($data_ang['kewarganegaraan'] == 'WNA') {
                                                                                                        echo 'checked';
                                                                                                    } ?>> WNA
                                        </label>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" value="<?= $data_ang['tempat_lahir']; ?>" name="tempat_lahir" placeholder="Masukan Tempat Lahir">
                                            <div class="input-group-append">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="date" class="form-control" value="<?= $data_ang['tanggal_lahir']; ?>" name="tanggal_lahir" placeholder="dd/mm/yyy">
                                            <div class="input-group-append">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="radio-inline">
                                            <input type="radio" name="jenis_kelamin" value="p" <?php if ($data_ang['jenis_kelamin'] == 'p') {
                                                                                                    echo 'checked';
                                                                                                } ?>> Pria
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="jenis_kelamin" value="w" <?php if ($data_ang['jenis_kelamin'] == 'w') {
                                                                                                    echo 'checked';
                                                                                                } ?>> Wanita
                                        </label>
                                    </div>
