...
if (isset($_GET['id_kk'])) {
	$kd_kartuKeluarga = $_GET['id_kk'];
	$data_kartuKeluarga = $lib->get_by_id_KKUser($kd_kartuKeluarga);
} else {
...
if (isset($_POST['tombol_update'])) {
	...
	$status_update = $lib->updateKartuKeluarga($kd_KK, $nama_kk, $almt, $rt, $rw, $kode_ps, $kel, $kec, $kab, $prov, $tglSah);
	if ($status_update) {
		echo "<script type='text/javascript'>alert('Berhasil Mengubah Data Kartu Keluarga!');window.location.href = 'index.php';</script>";
	} else {
		echo "<script type='text/javascript'>alert('Gagal Mengubah Data Kartu Keluarga, Silahkan Hubungi Admin Melalui Kontak Pada Halaman Utama Kami :)');window.location.href = 'index.php';</script>";
	}
}
?>
<!DOCTYPE html>
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>Formulir Ubah Kartu Keluarga</h1>
						</div>
						<div class="col-sm-6">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="alert alert-warning" role="alert">
										<i class="fa fa-info-circle"></i> Silahkan hubungi <b>Petugas</b>, jika ingin melakukan perubahan <b>Nomor Kartu Keluarga</b>!
									</div>
								</div>
								<div class="col-md-6">
									<form action="" method="post">
										<div class="form-group">
											...
											<div class="input-group">
												<input type="text" class="form-control" id='no_kk' name="no_kkx" value="<?php echo $data_kartuKeluarga['no_kk']; ?>" placeholder="Masukan Nomor Kartu Keluarga">
								...
								<div class="col-md-6">
									...
									<div class="form-group text-right">
										<input type="submit" name="tombol_update" class="btn btn-success" value="Ubah">
