...
if (isset($_POST['tombol_tambah'])) {
	...
	$add_status = $lib->registrasiAnggotaKeluarga($kd, $kk, $allN, $agama, $pek, $kew, $kel, $perk, $tml, $tgl, $jk, $gol);
	if ($add_status) {
		echo "<script type='text/javascript'>alert('Berhasil Menambah Data Anggota Keluarga!');window.location.href = 'tabel_anggota_keluarga.php';</script>";
	} else {
		echo "<script type='text/javascript'>alert('Gagal Menambah Data Anggota Keluarga, Silahkan Hubungi Admin Melalui Kontak Pada Halaman Utama Kami :)');window.location.href = 'tabel_anggota_keluarga.php';</script>";
	}
}
?>
<!DOCTYPE html>
					...
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						...
						<li class="nav-item has-treeview">
							...
							<ul class="nav nav-treeview">
								<li class="nav-item">
									<a href="form_anggota_keluarga.php" class="nav-link bg-cyan">
				...
				<div class="container-fluid">
					...
					<div class="card card-teal">
						<div class="card-header">
							<h3 class="card-title">Silahkan isi Form Anggota Keluarga</h3>
									...
									<form action="" method="post">
										<div class="form-group">
											...
											<div class="input-group">
												<input type="text" class="form-control" readonly value="<?= $_SESSION['no_kk']; ?>" name="nomor_kkeluarga" placeholder="Masukan Nomor Kartu Keluarga">
										...
										<div class="form-group">
											...
											<div class="input-group">
												<input type="text" class="form-control" name="all_name" placeholder="Masukan Nama Lengkap">
												<div class="input-group-append">
										...
										<div class="form-group">
											...
											<div class="input-group">
												<input type="number" class="form-control" name="pekerjaan" placeholder="Masukan Nomer Pekerjaan">
												<div class="input-group-append">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<select class="form-control" name="statusKel">
											...
											<option value="Belum Kawin">Famili Lain</option>
											<option value="PEMBANTU">Pembantu</option>
											<option value="Belum Kawin">Lainnya</option>
										</select>
									</div>
									<div class="form-group">
