...
if (isset($_POST['tombol_tambah'])) {
    ...
    //batas surat pindah
    $pindah = $_FILES['surat_keterangan_pindahx']['name'];
    $ukuran_file3 = $_FILES['surat_keterangan_pindahx']['size'];
    $tipe_file3 = $_FILES['surat_keterangan_pindahx']['type'];
    $tmp3 = $_FILES['surat_keterangan_pindahx']['tmp_name'];

    $sts = $_POST['status_pengajuan_prosesx'];

    $add_status = $lib->registrasiPelayananKTP_pindah(
        $kd,
        $kd_p,
        $nama,
        $tgl,
    ...
    if ($add_status) {
        echo "<script type='text/javascript'>alert('Berhasil melakukan pelayanan KTP!');window.location.href = 'ktp_baru_pindah.php';</script>";
    } else {
        echo "<script type='text/javascript'>alert('Gagal melakukan pelayanan KTP, Silahkan Hubungi Admin Melalui Kontak Kami :)');window.location.href = 'ktp_baru_pindah.php';</script>";
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>SPPDB - Pelayanan KTP Baru Pindah</title>
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item has-treeview">
                                    ...
                                    <ul class="nav nav-treeview">
                                        ...
                                        <li class="nav-item">
                                            <a href="ktp_baru_pindah.php" class="nav-link bg-cyan">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Formulir Pelayanan KTP Baru (Pindah)</h1>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <form id="form1" action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" readonly value="Membuat KTP Baru Pindah" name="keterangan_pelayanan" placeholder="Masukan Pelayanan">
                                                <div class="input-group-append">
                                ...
                                <div class="col-md-6" id="tampil">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputFile">Foto Surat Keterangan Pindah(max-size-file:2 Mb): <font color="red">*(wajib)</font></label>
                                        <input type="file" name="surat_keterangan_pindahx" class="form-control-file" id="exampleFormControlFile1">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <p>
                                            ...
                                            <font color="red">*Untuk KTP Baru pindah diwajibkan untuk mengisi foto surat keterangan pindah.</font>
                                        </p>
                                    </div>
                                    <div class="form-group">
