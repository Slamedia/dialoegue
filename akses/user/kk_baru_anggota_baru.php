...
if (isset($_POST['tombol_tambah'])) {
	...
	$add_status = $lib->registrasiKKBaruAnggota_Baru(
		$kd,
		$kd_p,
		$nama,
		$tgl,
	...
	if ($add_status) {
		echo "<script type='text/javascript'>alert('Berhasil melakukan pelayanan Kartu Keluarga!');window.location.href = 'kk_baru_anggota_baru.php';</script>";
	} else {
		echo "<script type='text/javascript'>alert('Gagal Melakukan pelayanan Kartu Keluarga, Silahkan Hubungi Admin Melalui Kontak Pada Halaman Utama Kami :)');window.location.href = 'kk_baru_anggota_baru.php';</script>";
	}
}
?>
<!DOCTYPE html>
...
<head>
	...
	<title>SPPDB - Pelayanan Kartu Keluarga Baru Anggota Baru</title>
							...
							<ul class="nav nav-treeview">
								<li class="nav-item has-treeview">
									...
									<ul class="nav nav-treeview">
										...
										<li class="nav-item">
											<a href="kk_baru_anggota_baru.php" class="nav-link  bg-cyan">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-7">
							<h1>Formulir Pelayanan Kartu Keluarga Baru (Anggota Baru)</h1>
						</div>
						<div class="col-sm-5">
						...
						<div class="card-body">
							<div class="row">
								<div class="col-md-6">
									<form id="form1" action="" method="post" enctype="multipart/form-data">
										...
										<div class="form-group">
											...
											<div class="input-group">
												<input type="text" class="form-control" name="keterangan_pelayanan" readonly value="Membuat Kartu Keluarga Baru Tambah Anggota" placeholder="Masukan Pelayanan">
												<div class="input-group-append">
								...
								<div class="col-md-6" id="tampil">
									...
									<div class="form-group">
										<label for="exampleInputFile">Foto Kartu Keluarga Lama(max-size-file:2 Mb): <font color="red">*(wajib)</font></label>
										<input type="file" name="kartu_keluarga_lamax" class="form-control-file" id="exampleFormControlFile1">
									</div>
									<div class="form-group">
										<label for="exampleInputFile">Foto Akte Kelahiran(max-size-file:2 Mb): <font color="red">*(wajib)</font></label>
									...
									<div class="form-group">
										...
										<p>
											<font color="red">*Untuk Kartu Keluarga Kehilangan tersedia di menu khusus kartu keluarga baru kehilangan diwajibkan untuk mengisi foto surat kehilangan Kartu Keluarga dan Foto Kartu Keluarga Lama.<br>
											</font>
										</p>
									</div>
									<div class="form-group">
