...
if (isset($_GET['hapus_pesan'])) {
	$kd_pesan = $_GET['hapus_pesan'];
	$status_hapus = $lib->deletePesan($kd_pesan);
	if ($status_hapus) {
		header('Location:tabel_data_pesan.php');
	}
}
?>
<!DOCTYPE html>
...
<head>
	...
	<title>SPPDB - Informasi Pesan</title>
...
<body class="hold-transition sidebar-mini">
					...
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						...
						<li class="nav-item has-treeview">
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item">
									<a href="tabel_data_pesan.php" class="nav-link bg-cyan">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>Informasi Pesan</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="#">Beranda</a></li>
								<li class="breadcrumb-item active">Tabel Data</li>
								<li class="breadcrumb-item active">Informasi Pesan</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="col-12">
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">Tabel Data Pesan <a target="_blank" href='print_data_pesan.php' class='btn btn-default'><i class='fa fa-print'></i> Print</a> <a href='javascript:exportData()' class='btn btn-success'><i class='fas fa-file-excel'></i> Export Excel</a></h3>
								</div>
								<!-- /.card-header -->
								<div class="card-body">
										...
										<table id="dtHorizontalVerticalExample" class="table table-bordered table-striped" cellspacing="0" width="100%">
											...
											<tbody>
												...
												foreach ($data_pesan as $row) {
													...
													echo "<td><a href='javascript:hapusData(" . $row['id_kontak'] . ")' class='btn btn-danger'><i class='fa fa-trash'></i> Hapus</button></td>";
													echo "</tr>";
													$no++;
												}
												?>
	...
	<script type="text/javascript">
		function exportData() {
			if (confirm("Apakah anda ingin export Data Pesan?")) {
				window.location.href = 'export_excel_pesan.php';
			} else {
				alert('Batal export Data Pesan!');
				window.location.href = 'tabel_data_pesan.php?export=batal';
			}
		}

		function hapusData(id_kontak) {
			if (confirm("Apakah anda yakin akan menghapus data ini?")) {
				alert('Berhasil Menghapus Data Pesan!');
				window.location.href = 'tabel_data_pesan.php?hapus_pesan=' + id_kontak;
			} else {
				alert('Batal Menghapus Data Pesan!');
				window.location.href = 'tabel_data_pesan.php?hapus_pesan=batal';
			}
		}
		$(function() {
			$("#example1").DataTable({
