...
if (isset($_POST['tombol_tambah'])) {
	...
	$add_status = $lib->registrasiAdmin($kd, $nama, $jk, $email, $pass, $alamat, $notlp);
	if ($add_status) {
		echo "<script type='text/javascript'>alert('Berhasil Menambah Data Admin!');window.location.href = 'tabel_admin.php';</script>";
	} else {
		echo "<script type='text/javascript'>alert('Gagal Menambah Data Admin!');window.location.href = 'form_admin.php';</script>";
	}
}
?>
<!DOCTYPE html>
							...
							<div class="row">
									...
									<form action="" method="post">
										<div class="form-group">
											...
											<div class="input-group">
												<input type="text" class="form-control" readonly value="<?php echo $id_admin_date; ?>" name="id_adminx" placeholder="Masukan ID Admin">
										...
										<div class="form-group">
											...
											<div class="input-group">
												<input type="text" class="form-control" name="nama_adminx" placeholder="Masukan Nama Admin">
												<div class="input-group-append">
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										<label>Akses:</label>
										<div class="input-group">
											<input type="text" class="form-control" readonly name="aksesx" value="Admin" placeholder="Masukan Akses">
											<div class="input-group-append">
