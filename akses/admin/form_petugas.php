...
if (isset($_POST['tombol_tambah'])) {
	...
	$add_status = $lib->registrasiPetugas($kd, $nama, $jk, $email, $pass, $alamat, $notlp);
	if ($add_status) {
		echo "<script type='text/javascript'>alert('Berhasil Menambah Data Petugas!');window.location.href = 'tabel_petugas.php';</script>";
	} else {
		echo "<script type='text/javascript'>alert('Gagal Menambah Data Petugas!');window.location.href = 'form_petugas.php';</script>";
	}
}
?>
<!DOCTYPE html>
							...
							<div class="row">
									...
									<form action="" method="post">
										<div class="form-group">
											...
											<div class="input-group">
												<input type="text" class="form-control" name="nipx" placeholder="Masukan NIP">
										...
										<div class="form-group">
											...
											<div class="input-group">
												<input type="text" class="form-control" name="nama_lengkap_petugasx" placeholder="Masukan Nama Petugas">
												<div class="input-group-append">
										...
										<div class="form-group">
											<label>Email:</label>
											<div class="input-group">
												<input type="text" class="form-control" name="emailx" placeholder="Masukan Email">
												<div class="input-group-append">
										...
										<div class="form-group">
											...
											<div class="input-group" id="show_hide_password">
												<input class="form-control" type="password" name="passwordx" id="password" placeholder="Masukan Password">
												<div class="input-group-append">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label>Alamat:</label>
										<div class="input-group">
											<input type="text" class="form-control" name="alamatx" placeholder="Masukan Alamat">
											<div class="input-group-append">
									...
									<div class="form-group">
										...
										<div class="input-group">
											<input type="text" class="form-control" name="no_tlpx" placeholder="Masukan Nomor Handphone">
											<div class="input-group-append">
