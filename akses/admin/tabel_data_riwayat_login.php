...
// 	$kd_riwayat_login = $_GET['id_akses_login'];
// 	$status_hapus = $lib->deleteRiwayatLogin($kd_riwayat_login);
// 	if ($status_hapus) {
// 		header('Location:tabel_data_riwayat_login.php');
// 	}
// }
// 
?>
...
<head>
	...
	<title>SPPDB - Informasi Riwayat Login</title>
...
<body class="hold-transition sidebar-mini">
					...
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						...
						<li class="nav-item has-treeview">
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item">
									<a href="tabel_data_riwayat_login.php" class="nav-link bg-cyan">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>Informasi Riwayat Login Website SPPDB</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="#">Beranda</a></li>
								<li class="breadcrumb-item active">Tabel Data</li>
								<li class="breadcrumb-item active">Informasi Riwayat Login</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="col-12">
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">Tabel Data Riwayat Login Website SPPDB <a target="_blank" href='print_data_riwayat_login.php' class='btn btn-default'><i class='fa fa-print'></i> Print</a> <a href='javascript:exportData()' class='btn btn-success'><i class='fas fa-file-excel'></i> Export Excel</a></h3>
								</div>
								<!-- /.card-header -->
								<div class="card-body">
										...
										<table id="dtHorizontalVerticalExample" class="table table-bordered table-striped" cellspacing="0" width="100%">
											...
											<tbody>
												...
												foreach ($data_riwayatLoginSite as $row) {
													...
													if ($tgl_format1 = $row['tanggal_akses_login'] == "") {
														$tgl_format1 = $row['tanggal_akses_login'];
														$tgl_format2 = "<font color='red'>Belum Melakukan Akses</font>";
													} else {
														$tgl_format1 = $row['tanggal_akses_login'];
	...
	<script type="text/javascript">
		function exportData() {
			if (confirm("Apakah anda ingin export Data Riwayat Login?")) {
				window.location.href = 'export_excel_riwayat_login.php';
			} else {
				alert('Batal export Data Riwayat Login!');
				window.location.href = 'tabel_data_riwayat_login.php?export=batal';
			}
		}
		$(function() {
			$("#example1").DataTable({
