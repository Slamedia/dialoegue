...
if (isset($_POST['tombol_tambah'])) {
	...
	$add_status = $lib->registrasiP($kd, $kk, $fn, $ln, $agama, $pek, $kew, $kel, $perk, $tml, $tgl, $jk, $gol, $email, $pass, $tlp);
	if ($add_status) {
		echo "<script type='text/javascript'>alert('Berhasil Menambah Data Penduduk!');window.location.href = 'tabel_data_penduduk.php';</script>";
	}
}
?>
<!DOCTYPE html>
...
<head>
	...
	<title>SPPDB - Form Penduduk</title>
							...
							<div class="row">
								<div class="col-md-6">
									<form action="" method="post">
										...
										<div class="form-group">
											...
											<div class="input-group">
												<input type="text" class="form-control" name="nomor_kkeluarga" placeholder="Masukan Nomor Kartu Keluarga">
												<div class="input-group-append">
										...
										<div class="form-group">
											...
											<div class="input-group">
												<input type="text" class="form-control" name="first_name" placeholder="Masukan Nama Depan">
												<div class="input-group-append">
										...
										<div class="form-group inline">
											...
											<div class="input-group">
												<input type="text" class="form-control" name="last_name" placeholder="Masukan Nama Belakang">
												<div class="input-group-append">
													<div class="input-group-text"><i class="fa fa-user"></i></div>
												</div>
											</div>
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<div class="input-group">
											<input type="text" class="form-control" name="tanggal_lahir" placeholder="Masukan Tanggal Lahir">
											<div class="input-group-append">
									...
									<div class="form-group">
										...
										<div class="input-group">
											<input type="text" class="form-control" name="notlp" placeholder="Masukan Nomor Handphone">
											<div class="input-group-append">
