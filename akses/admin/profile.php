...
if (isset($_SESSION['id_admin'])) {
  $kd_mins = $_SESSION['id_admin'];
  $data_admins = $lib->get_by_id_Admins($kd_mins);
} else {
  header('Location: home.php');
}
$data_pesan_admin =  $lib->showPesanLimitAdmin();
...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <?php
      if ($jk = $data_admins["jenis_kelamin"] == 'p') {
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="profile.php" class="d-block"><?php echo $data_admins['nama_admin']; ?></a>
          </div>
        </div>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="home.php" class="nav-link bg-cyan">
              ...
              <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                  ...
                  <h3 class="profile-username text-center"><?php $dot = '';
                                                            if ($data_admins['status'] == 'OFFLINE') {
                                                              $dot = '<span class="dot bg-danger"></span>';
                                                            } else {
                                                              $dot = '<span class="dot bg-success"></span>';
                                                            }
                                                            echo $dot . " ";
                                                            echo $data_admins['nama_admin']; ?></h3>

                  <p style="text-transform:capitalize;" class="text-muted text-center"><?php echo $data_admins['akses']; ?></p>

                  <ul class="list-group list-group-unbordered mb-3">
                    <li class="list-group-item">
                      <b>Jenis Kelamin</b> <a class="float-right"><?php if ($data_admins['jenis_kelamin'] == 'p') {
                                                                    echo $jk = 'Pria';
                                                                  } else {
                                                                    echo $jk = 'Wanita';
                                                                  } ?> </a>
                    ...
                    <li class="list-group-item">
                      <b>Nomor Handphone</b> <a class="float-right"><?php echo $data_admins['no_tlp']; ?> </a>
                    </li>
                    <li class="list-group-item">
                      <b>Alamat</b> <a class="float-right"><?php echo $data_admins['alamat']; ?> </a>
                    </li>
                    <li class="list-group-item">
                      <b>Email</b> <a class="float-right"><?php echo $data_admins['email']; ?> </a>
                    </li>
                  </ul>
                </div>
                <!-- /.card-body -->
                ...
                <div class="card-body">
                  <div class="tab-content">
                    <div class="active tab-pane" id="activity">
                      <?php
                      foreach ($data_pesan_admin as $row) {
                      ?>
                        <!-- Post -->
                        <div class="post">
                          <div class="user-block">
                            ...
                            <span class="username">
                              <a href="#"><?php if ($row['nama_kontak'] == '') {
                                            echo 'Pengirim Tidak Dikenal';
                                          } else {
                                            echo $row['nama_kontak'];
                                          } ?></a>
                              <a href="#" class="float-right btn-tool"><i class="fas fa-thumbtack"></i></a>
                            </span>
                            <span class="description">Shared publicly - <?php $tgl_format1 = $row['tanggal_send'];
                          ...
                          <p><?php
                              if ($row['komentar'] == '') {
                                echo 'Data Pesan Belum Tersedia!';
                              } else {
                                echo $row['komentar'];
                              } ?>
                          </p>
