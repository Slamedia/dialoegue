...
if (isset($_GET['id_akses_login'])) {
	...
	$data_petugas = $lib->get_by_id_petugas($kd_petugas);
} else {
...
if (isset($_POST['tombol_ubah'])) {
	$kd = $_POST['nipx'];
	$nama = $_POST['nama_lengkap_petugasx'];
	...
	$add_status = $lib->updatePetugas($kd, $nama, $jk, $email, $alamat, $notlp);
	if ($add_status) {
		echo "<script type='text/javascript'>alert('Berhasil Mengubah Data Petugas!');window.location.href = 'tabel_petugas.php';</script>";
	} else {
		echo "<script type='text/javascript'>alert('Gagal Mengubah Data Petugas!');window.location.href = 'form_edit_petugas.php';</script>";
	}
}
?>
<!DOCTYPE html>
...
<head>
	...
	<title>SPPDB - Form Petugas</title>
					...
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						...
						<li class="nav-item has-treeview">
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item">
									<a href="form_petugas.php" class="nav-link bg-cyan">
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Formulir Petugas</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="container-fluid">
					...
					<div class="card card-teal">
						<div class="card-header">
							<h3 class="card-title">Silahkan isi Form Petugas</h3>
							...
							<div class="row">
									...
									<form action="" method="post">
										<div class="form-group">
											...
											<div class="input-group">
												<input type="text" class="form-control" name="nipx" readonly value="<?= $data_petugas['nip']; ?>" placeholder="Masukan NIP">
										...
										<div class="form-group">
											...
											<div class="input-group">
												<input type="text" class="form-control" name="nama_lengkap_petugasx" value="<?= $data_petugas['nama_lengkap_petugas']; ?>" placeholder="Masukan Nama Petugas">
												<div class="input-group-append">
										...
										<div class="form-group">
											...
											<label class="radio-inline">
												<input type="radio" name="jenis_kelamin" <?php if ($data_petugas['jenis_kelamin'] == 'p') {
																								echo 'checked';
																							} ?> value="p" checked> Pria
											</label>
											<label class="radio-inline">
												<input type="radio" name="jenis_kelamin" <?php if ($data_petugas['jenis_kelamin'] == 'w') {
																								echo 'checked';
																							} ?> value="w"> Wanita
											</label>
										</div>
										<div class="form-group">
											<label>Email:</label>
											<div class="input-group">
												<input type="text" class="form-control" value="<?= $data_petugas['email']; ?>" name=" emailx" placeholder="Masukan Email">
												<div class="input-group-append">
										...
										<div class="form-group">
											...
											<div class="input-group" id="show_hide_password">
												<input class="form-control" type="password" readonly value="<?= $data_petugas['password']; ?>" name="passwordx" id="password" placeholder="Masukan Password">
												<div class="input-group-append">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label>Alamat:</label>
										<div class="input-group">
											<input type="text" class="form-control" value="<?= $data_petugas['alamat']; ?>" name="alamatx" placeholder="Masukan Alamat">
											<div class="input-group-append">
									...
									<div class="form-group">
										...
										<div class="input-group">
											<input type="text" class="form-control" name="no_tlpx" value="<?= $data_petugas['no_tlp']; ?>" placeholder="Masukan Nomor Handphone">
											<div class="input-group-append">
									...
									<div class="form-group">
										<label>Akses:</label>
										<div class="input-group">
											<input type="text" class="form-control" readonly name="aksesx" value="Petugas" placeholder="Masukan Akses">
											<div class="input-group-append">
									...
									<div class="form-group text-right">
										<input type="submit" name="tombol_ubah" class="btn btn-success" value="Tambah">
