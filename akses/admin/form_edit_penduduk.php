...
if (isset($_POST['tombol_ubah'])) {
	...
	if ($status_update) {
		echo "<script type='text/javascript'>alert('Berhasil Mengubah Data Penduduk!');window.location.href = 'tabel_data_penduduk.php';</script>";
	} else {
		echo "gagal";
	}
}
					...
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						...
						<li class="nav-item has-treeview">
							...
							<ul class="nav nav-treeview">
								<li class="nav-item">
									<a href="form_penduduk.php" class="nav-link bg-cyan">
									...
									<form action="" method="post">
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" class="form-control" name="nik" value="<?= $data_penduduk['nik']; ?>" placeholder="Masukan Nomor Kartu Keluarga">
										...
										<div class="form-group">
											...
											<div class="input-group">
												<input type="text" class="form-control" readonly name="nomor_kkeluarga" value="<?= $data_penduduk['no_kk']; ?>" placeholder="Masukan Nomor Kartu Keluarga">
												<div class="input-group-append">
													<div class="input-group-text"><i class="fas fa-id-badge"></i></div>
												</div>
											</div>
										...
										<div class="form-group">
											...
											<select class="form-control" name="agama">
												...
												<option <?php if ($data_penduduk['agama'] == 'Islam') {
															echo 'selected';
														} ?> value="Islam">Islam</option>
												<option <?php if ($data_penduduk['agama'] == 'Kristen(Protestan)') {
															echo 'selected';
														} ?> value="Kristen(Protestan)">Kristen(Protestan)</option>
												<option <?php if ($data_penduduk['agama'] == 'Katolik') {
															echo 'selected';
														} ?>value="Katolik">Katolik</option>
												<option <?php if ($data_penduduk['agama'] == 'Budha') {
															echo 'selected';
														} ?> value="Budha">Budha</option>
												<option <?php if ($data_penduduk['agama'] == 'Hindu') {
															echo 'selected';
														} ?> value="Hindu">Hindu</option>
												<option <?php if ($data_penduduk['agama'] == 'Konghucu') {
															echo 'selected';
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<select class="form-control" name="statusKel">
											...
											<option <?php if ($data_penduduk['status_hub_kel'] == 'KEPALA KELUARGA') {
														echo 'selected';
													} ?> value="KEPALA KELUARGA">Kepala Keluarga</option>
											<option <?php if ($data_penduduk['status_hub_kel'] == 'SUAMI') {
														echo 'selected';
													} ?> value="SUAMI">Suami</option>
											<option <?php if ($data_penduduk['status_hub_kel'] == 'ISTRI') {
														echo 'selected';
													} ?> value="ISTRI">Istri</option>
											<option <?php if ($data_penduduk['status_hub_kel'] == 'ANAK') {
														echo 'selected';
													} ?> value="ANAK">Anak</option>
											<option <?php if ($data_penduduk['status_hub_kel'] == 'MENANTU') {
														echo 'selected';
													} ?> value="MENANTU">Menantu</option>
											<option <?php if ($data_penduduk['status_hub_kel'] == 'CUCU') {
														echo 'selected';
													} ?> value="CUCU">Cucu</option>
											<option <?php if ($data_penduduk['status_hub_kel'] == 'ORANG TUA') {
														echo 'selected';
													} ?> value="ORANG TUA">Orang tua</option>
											<option <?php if ($data_penduduk['status_hub_kel'] == 'MERTUA') {
														echo 'selected';
													} ?> value="MERTUA">Mertua</option>
											<option <?php if ($data_penduduk['status_hub_kel'] == 'FAMILI LAIN') {
														echo 'selected';
													} ?> value="FAMILI LAIN">Famili Lain</option>
											<option <?php if ($data_penduduk['status_hub_kel'] == 'PEMBANTU') {
														echo 'selected';
													} ?> value="PEMBANTU">Pembantu</option>
											<option <?php if ($data_penduduk['status_hub_kel'] == 'LAINNYA') {
														echo 'selected';
									...
									<div class="form-group">
										...
										<select class="form-control" name="statusP">
											...
											<option <?php if ($data_penduduk['status_perkawinan'] == 'Belum Kawin') {
														echo 'selected';
													} ?> value="Belum Kawin">Belum Kawin</option>
											<option <?php if ($data_penduduk['status_perkawinan'] == 'Kawin') {
														echo 'selected';
													} ?> value="Kawin">Kawin</option>
											<option <?php if ($data_penduduk['status_perkawinan'] == 'Cerai Hidup') {
														echo 'selected';
													} ?> value="Cerai Hidup">Cerai Hidup</option>
											<option <?php if ($data_penduduk['status_perkawinan'] == 'Cerai Mati') {
														echo 'selected';
									...
									<div class="form-group">
										...
										<div class="input-group">
											<input type="text" class="form-control" value="<?= $data_penduduk['tanggal_lahir']; ?>" name="tanggal_lahir" placeholder="Masukan Tanggal Lahir">
											<div class="input-group-append">
									...
									<div class="form-group">
										...
										<select class="form-control" name="gold">
											...
											<option <?php if ($data_penduduk['Goldarah'] == 'O+') {
														echo 'selected';
													} ?> value="O+">O+</option>
											<option <?php if ($data_penduduk['Goldarah'] == 'O-') {
														echo 'selected';
													} ?> value="O-">O-</option>
											<option <?php if ($data_penduduk['Goldarah'] == 'A+') {
														echo 'selected';
													} ?> value="A+">A+</option>
											<option <?php if ($data_penduduk['Goldarah'] == 'A-') {
														echo 'selected';
													} ?> value="A-">A-</option>
											<option <?php if ($data_penduduk['Goldarah'] == 'B+') {
														echo 'selected';
													} ?> value="B+">B+</option>
											<option <?php if ($data_penduduk['Goldarah'] == 'B-') {
														echo 'selected';
