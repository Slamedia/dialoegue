...
if (isset($_GET['hapus_penduduk'])) {
	...
	if ($status_hapus) {
		echo "<script type='text/javascript'>alert('Berhasil Menghapus Data Penduduk!');window.location.href = 'tabel_data_penduduk.php';</script>";
	} else {
		echo "<script type='text/javascript'>alert('Gagal Menghapus Data Penduduk!, Akun Sudah Melakukan Pelayanan');window.location.href = 'tabel_data_penduduk.php';</script>";
	}
}
?>
<!DOCTYPE html>
				...
				<nav class="mt-2">
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						...
						<li class="nav-item has-treeview">
							...
							<ul class="nav nav-treeview">
								<li class="nav-item">
									<a href="tabel_data_penduduk.php" class="nav-link bg-cyan">
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Informasi Penduduk</li>
							</ol>
						</div>
					</div>
				</div>
										...
										<table id="dtHorizontalVerticalExample" class="table table-bordered table-striped" cellspacing="0" width="100%">
											...
											<tbody>
												...
												foreach ($data_penduduk as $row) {
													...
													echo "<td><a href='form_edit_penduduk.php?id_pen=" . $row['id_pen'] . "' class='btn btn-info'><i class='fa fa-edit'></i> Update</a>
											<a href='tabel_data_penduduk.php?hapus_penduduk=" . $row['id_akses_login'] . "' class='btn btn-danger'><i class='fa fa-trash'></i> Hapus</a></td>";
													echo "</tr>";
													$no++;
												}
												?>
