...
if (isset($_POST['tombol_tambah'])) {
	...
	if ($add_status) {
		echo "<script type='text/javascript'>alert('Berhasil melakukan pelayanan KTP Baru!');window.location.href = 'ktp_baru.php';</script>";
	} else {
						...
						<div class="card-body">
							<div class="row">
								<div class="col-md-6">
									<form id="form1" action="" method="post" enctype="multipart/form-data">
										...
										<div class="form-group">
											...
											<div class="input-group">
												<input type="text" class="form-control" id="nik" name="nik_pendudukx" placeholder="Masukan Nomor NIK">
												<div class="input-group-append">
										...
										<div class="form-group">
											...
											<select class="form-control" name="keterangan_pelayanan">
												...
												<option value="Membuat KTP Baru">Membuat KTP Baru</option>
												<option value="Membuat KTP Baru(Kehilangan)">Membuat KTP Baru Kehilangan</option>
											</select>
										</div>
										<div class="form-group">
								...
								<div class="col-md-6" id="tampil">
									...
									<div class="form-group">
										<label for="exampleInputFile">Foto Surat Keterangan Pindah(max-size-file:2 Mb):</label>
