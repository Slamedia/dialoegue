...
if (isset($_GET['hapus_kk'])) {
	...
	if ($status_hapus) {
		echo "<script type='text/javascript'>alert('Berhasil Menghapus Data Kartu Keluarga!');window.location.href = 'tabel_data_kartu_keluarga.php';</script>";
	}
}
...
<head>
	...
	<title>SPPDB - Informasi Kartu Keluarga</title>
					...
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						...
						<li class="nav-item has-treeview">
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item">
									<a href="tabel_data_kartu_keluarga.php" class="nav-link bg-cyan">
										...
										<table id="dtHorizontalVerticalExample" class="table table-bordered table-striped" cellspacing="0" width="100%">
											...
											<tbody>
												...
												foreach ($data_KK as $row) {
													...
													echo "<td>" . $row['nama_kepalaKeluarga'] . "</td>";
													...
													echo "<td>" . $row['tglsahKK'] . "</td>";
													echo "<td>" . $row['tgl_update'] . "</td>";
													echo "<td><a href='form_edit_kartu_keluarga.php?nomor_kartu=" . $row['no_kk'] . "' class='btn btn-info'><i class='fa fa-edit'></i> Update</a>
													<a href='tabel_data_kartu_keluarga.php?hapus_kk=" . $row['no_kk'] . "' class='btn btn-danger'><i class='fa fa-trash'></i> Hapus</a></td>";
													echo "</tr>";
													$no++;
												}
												?>
