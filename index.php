...
"></span>
        ...
        <a class="navbar-brand" href="#myPage"><img src="library/img/logo.png"></a>
      </div>
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav navbar-right">
          <li><a href="#home">HOME</a></li>
          <li><a href="produk.php">PRODUK</a></li>
          <li><a href="menu/bisnis.php">BISNIS</a></li>
          <li><a href="menu/faq.php">FAQ</a></li>
  ...
  <div id="home" class="jumbotron text-left" style="position: relative; margin-bottom: 0px;">
    <div class="row">
      <div class="col-sm-8">
        <p><h2>Ayo!</h2><h2>jadi 500 yang pertama</h2>
          <h2>mencoba produk</h2><h2>yang kamu suka</h2><h2>secara gampang,</h2><h2>yuk review dulu di website!!</h2>
...
<!-- pelayanan -->
  <div id="pelayanan" class="container-fluid text-center">
    <h2 style="font-family: cursive; color: #fff;">KATEGORI</h2>
    <br>
    <div class="row slideanim">
      <div class="col-sm-4" style="position: relative; left: -2px;">
        <span class="glyphicon glyphicon-lock logo-small"></span>
        <h4>Keamanan</h4>
        <p>Keamanan Akun & Dokumen Penduduk Terjaga</p>
      </div>
      <div class="col-sm-4" style="position: relative; left: -2px;">
        <span class="glyphicon glyphicon-lock logo-small"></span>
        <h4>Keamanan</h4>
  ...
  <img src="library/img/background-utama.jpg" class="w3-image w3-greyscale-min" style="width:100%">
  <!-- foter -->
